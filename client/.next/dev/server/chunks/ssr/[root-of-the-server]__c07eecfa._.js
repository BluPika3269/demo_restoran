...
function Gallery() {
    ...
    const [nailDesigns, setNailDesigns] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const fetchGellakServices = async ()=>{
        try {
            ...
            const gellakCategory = categories.find((cat)=>cat.name === 'Gellak');
            if (gellakCategory) {
                setNailDesigns(gellakCategory.services.map((service)=>({
                        id: service.id,
                        name: service.name,
                        description: service.description,
                        image: service.image || 'https://images.unsplash.com/photo-1610992015732-2449b0c26670?w=800&h=600&fit=crop',
                        price: `${service.price}€`
                    })));
            }
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c07eecfa._.js.map
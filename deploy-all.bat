...
cd client
echo postgresql://neondb_owner:npg_rgSBQKc4Gk1T@ep-flat-credit-agkt1oxd-pooler.c-2.eu-central-1.aws.neon.tech/neondb?sslmode=require^&connection_limit=1^&pool_timeout=0 | call vercel env add DATABASE_URL production --force
